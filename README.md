...
_Formação prática e intensiva, me habilitando para atuar como desenvolvedor(a) Full Stack. Ensino focado nas habilidades técnicas para atuar imediatamente no mercado de trabalho. Aprendi técnicas de construção de uma aplicação passando por todas as suas camadas lógicas - backend, frontend, persistência de dados NoSQL, controle de versionamento de código com Git e implantação em nuvem, me habilitando para atuar profissionalmente na área._
